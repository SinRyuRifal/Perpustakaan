 ...
 * @author Rifal
 */
public class Dialog_DataInventaris extends javax.swing.JDialog {

    private boolean inventarisSelected = false;
    private String selectednoInventaris = null;
    private String selectedLokasi = null;

    public boolean isinventarisSelected() {
        return inventarisSelected;
    }

    public String getselectednoInventaris() {
        return selectednoInventaris;
    }
    ...
    private void loadData() {
        ...
        terMOdel.addColumn("No Inventaris");
        terMOdel.addColumn("Lokasi");
    ...
    private void filterDataSupplier(String keyword, String selectedField) {
        ...
        String sql = "SELECT * FROM INVENTARIS WHERE ";

        switch (selectedField) {
            case "No Inventaris":
                sql += "NO_INVENTARIS LIKE ?";
                break;
            case "Lokasi":
                sql += "Lokasi LIKE ?";
                break;
    ...
    public Dialog_DataInventaris(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        cb_cari.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "No Inventaris", "Lokasi" }));
    ...
    private void btn_pilihActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_pilihActionPerformed
        ...
        if (selectedRow != -1) {
            ...
            selectednoInventaris = tblBuku.getValueAt(selectedRow, 0).toString();
            selectedLokasi = tblBuku.getValueAt(selectedRow, 1).toString();

            inventarisSelected = true;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Dialog_DataInventaris dialog = new Dialog_DataInventaris(new javax.swing.JFrame(), true);
