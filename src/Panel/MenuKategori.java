...
txt_search.getDocument().addDocumentListener(new DocumentListener() {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Daftar Kategori");

        lb_iconAnggota.setBackground(new java.awt.Color(250, 250, 250));
        lb_iconAnggota.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/—Pngtree—pile of cartoonish cute doodle_6871556 (1).png"))); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/kategori.png"))); // NOI18N
        ...
        jLabel13.setText("Input Kategori");

        jLabel14.setFont(new java.awt.Font("SansSerif", 1, 18)); // NOI18N
        jLabel14.setText("Tambah Kategori");

        lb_iconAnggota2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/—Pngtree—pile of cartoonish cute doodle_6871556 (2).png"))); // NOI18N
    ...
    private void btn_ImportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ImportActionPerformed
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            importExcelToDatabaseKategori(selectedFile);
            loadData();
        }
    ...
    private void btn_EcportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_EcportActionPerformed
      try {
        ...
        XSSFSheet sheet = workbook.createSheet("Kategori Data");
 ...
 private void importExcelToDatabaseKategori(File file) {
        try {
            ...
            while (rowIterator.hasNext()) {
                ...
                String idKategori = getCellValueAsString(cellIterator.next());
                String namaKategori = getCellValueAsString(cellIterator.next());

              
                if (isIdKategoriExists(conn, idKategori)) {
                    System.out.println("Skipping row with idKategori " + idKategori + " as it already exists.");
                    continue;  
                }

             
                insertDataToDatabaseKategori(conn, idKategori, namaKategori);
            }
    ...
    private boolean isIdKategoriExists(Connection conn, String idKategori) throws SQLException {
        String query = "SELECT COUNT(*) AS count FROM kategori WHERE ID_Kategori=?";
...
private String getCellValueAsString(Cell cell) {
    ...
    private void insertDataToDatabaseKategori(Connection conn, String idKategori, String namaKategori) throws SQLException {
      String query = "INSERT INTO kategori (id_kategori, nama_kategori) VALUES (?, ?)";
    try (PreparedStatement preparedStatement = conn.prepareStatement(query)) {
        preparedStatement.setString(1, idKategori);
        preparedStatement.setString(2, namaKategori);
...
tblData.setAutoCreateRowSorter(true);
       ...
       try (Connection conn = Koneksi.getConnection()) {
            ...
            try (PreparedStatement st = conn.prepareStatement(sql)) {
                ...
                while (rs.next()) {
                    ...
                    Object[] rowData = {idKategori, namaKategori};
   ...
   private String setIDKategori() {
    ...
    String sql = "SELECT RIGHT(ID_Kategori, 3) AS Nomor "
            + "FROM Kategori "
            + "WHERE ID_Kategori LIKE 'KTG" + noFormat.format(now) + "%' "
    ...
    try (Connection conn = Koneksi.getConnection();
        ...
        if (rs.next()) {
            ...
            urutan = "KTG" + noFormat.format(now) + String.format("%03d", nomor);
        } else {
            urutan = "KTG" + noFormat.format(now) + "001";
        }
    ...
    public boolean validasiNama() {
        ...
        try (PreparedStatement st = conn.prepareStatement(sql)) {
            ...
            if (rs.next()) {
                JOptionPane.showMessageDialog(this, "Kategori sudah ada\nSilahkan input Nama Kategori yang berbeda",
    ...
    private void dataTabel() {
        ...
        jLabel14.setText("Perbarui Data Kategori Buku");
        txtID.setEnabled(false);
