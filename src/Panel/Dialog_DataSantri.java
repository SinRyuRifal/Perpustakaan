 ...
 * @author Rifal
 */
public class Dialog_DataSantri extends javax.swing.JDialog {

    private boolean santriSelected = false;
    private String selectedNISNSantri = null;
    private String selectednamaSantri = null;

    public boolean issantriSelected() {
        return santriSelected;
    }
    ...
    private void filterDataSupplier(String keyword, String selectedField) {
        DefaultTableModel filModel = (DefaultTableModel) tblDialog.getModel();
    ...
    public Dialog_DataSantri(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        cb_cari.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nama Anggota", "NISN" }));
    ...
    private void btn_pilihActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_pilihActionPerformed
        ...
        if (selectedRow != -1) {
            ...
            selectedNISNSantri = tblDialog.getValueAt(selectedRow, 0).toString();
            selectednamaSantri = tblDialog.getValueAt(selectedRow, 1).toString();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Dialog_DataSantri dialog = new Dialog_DataSantri(new javax.swing.JFrame(), true);
