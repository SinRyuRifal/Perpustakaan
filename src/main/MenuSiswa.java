...
private ImageIcon getResizedImageIcon(String loggedInUsername, int targetWidth, int targetHeight) {
    ...
    try {
        ...
        String sql = "SELECT Gambar FROM Anggota WHERE NISN = ?";
...
private void setResizedGambarIcon(int targetWidth, int targetHeight) {
    ...
    public MenuSiswa() {
     ...
     String namaSantri = formLogin.getNamaSantri();
        jLabel3.setText(loggedInUsername + " - " + namaSantri);
...
setResizedGambarIcon(60, 70);
        ...
        gradient1Layout.setHorizontalGroup(
            ...
            .addGroup(gradient1Layout.createSequentialGroup()
                ...
                .addGroup(gradient1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(lb_tanggal, javax.swing.GroupLayout.DEFAULT_SIZE, 223, Short.MAX_VALUE)
        ...
        gradient1Layout.setVerticalGroup(
            ...
            .addGroup(gradient1Layout.createSequentialGroup()
                ...
                .addGroup(gradient1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, gradient1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(jLabel1)
                        .addGroup(gradient1Layout.createSequentialGroup()
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      MenuItem EntryBuku = new MenuItem(null, true, iconEntry, "Entry Buku", new ActionListener() {
       ...
       MenuItem PeminjamanR = new MenuItem(null, true, iconPinjam, "Peminjaman", new ActionListener() {
        ...
        MenuItem PengembalianRSiswa = new MenuItem(null, true, iconRetrun, "Pengembalian", new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                pn_utama.removeAll();
                pn_utama.add(new LaporanPengembalianSantri());
                pn_utama.repaint();
                pn_utama.revalidate();
            }
        });
       MenuItem PeminjamanRSiswa = new MenuItem(null, true, iconPinjam, "Peminjaman", new ActionListener() {
           
            @Override
            public void actionPerformed(ActionEvent e) {
                pn_utama.removeAll();
                pn_utama.add(new LaporanPeminjamanSantri());
                pn_utama.repaint();
                pn_utama.revalidate();
            }
        });
 ...
 MenuItem menuBuku2 = new MenuItem(iconBuku2, false, null, "Master Buku", null, EntryBuku, EntryInventaris);
      MenuItem menuBuku = new MenuItem(iconBuku, false, null, "Buku", null, List);
      
      MenuItem menuAnggota = new MenuItem(iconPerpus, false, null, "Anggota", null, Santri, Penjaga);
       
        MenuItem menuLaporan = new MenuItem(iconLaporan, false, null, "Laporan", null, PeminjamanRSiswa, PengembalianRSiswa);
      
 addMenu(menuHome, menuDashboard,menuBuku, menuLaporan, menuLogout);
    }
