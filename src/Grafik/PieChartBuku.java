 ...
 * @author raven
 */
public class PieChartBuku extends javax.swing.JFrame {
...
"    monthNumber, monthText";
    ...
    private void showData(int year, int month){
       try{
           pieChart1.clearData();
           String sql = "SELECT\n" +
"    BUKU.JUDUL_BUKU AS judulBuku,\n" +
"    COUNT(DETAIL_PEMINJAMAN.ID_BUKU) AS TotalPeminjaman\n" +
"FROM\n" +
"    PEMINJAMAN\n" +
"    JOIN DETAIL_PEMINJAMAN ON PEMINJAMAN.ID_PEMINJAMAN = DETAIL_PEMINJAMAN.ID_PEMINJAMAN\n" +
"    JOIN ENTRY ON DETAIL_PEMINJAMAN.ID_BUKU = ENTRY.ID_BUKU\n" +
"    JOIN BUKU ON ENTRY.ISBN = BUKU.ISBN\n" +
"WHERE\n" +
...
"    judulBuku;";
   ...
   public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PieChartBuku().setVisible(true);
            }
        });
    }
