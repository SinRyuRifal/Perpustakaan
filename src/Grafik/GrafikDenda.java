...
public class GrafikDenda extends javax.swing.JFrame {

    
    public GrafikDenda() {
        initComponents();
        chart.setTitle("Chart Data");
        chart.addLegend("Total Denda", Color.decode("#7b4397"), Color.decode("#dc2430"));
        setDataPesan();
    }
...
"    SUM(TOTAL_DENDA) AS \"Total Denda\"\n" +
"FROM \n" +
"    PENGEMBALIAN\n" +
"WHERE \n" +
...
"    YEAR(TANGGAL_DIKEMBALIKAN) DESC, EXTRACT(MONTH FROM TANGGAL_DIKEMBALIKAN) DESC";
        ...
        while (r.next()) {
            ...
            double amount = r.getDouble("Total Denda");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GrafikDenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GrafikDenda().setVisible(true);
            }
        });
    }
