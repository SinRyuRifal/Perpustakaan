...
public class GrafikPenjaga extends javax.swing.JFrame {

    public GrafikPenjaga() {
        initComponents();
    ...
    public void setDataAnggota() {
        try {
            ...
            if (optionYear == JOptionPane.OK_OPTION) {
                ...
                String sql = "SELECT \n"
                        + "    EXTRACT(MONTH FROM TANGGAL_BERGABUNG_PENJAGA) AS month,\n"
                        + "    DATE_FORMAT(TANGGAL_BERGABUNG_PENJAGA, '%M') AS month_name,\n"
                        + "    COUNT(*) AS \"Jumlah Pendaftaran\"\n"
                        + "FROM Penjaga\n"
                        + "WHERE EXTRACT(YEAR FROM TANGGAL_BERGABUNG_PENJAGA) = ?\n"
                        + "GROUP BY EXTRACT(MONTH FROM TANGGAL_BERGABUNG_PENJAGA), month_name\n"
                        + "ORDER BY EXTRACT(YEAR FROM TANGGAL_BERGABUNG_PENJAGA) DESC, EXTRACT(MONTH FROM TANGGAL_BERGABUNG_PENJAGA) DESC";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GrafikPenjaga.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GrafikPenjaga().setVisible(true);
            }
        });
    }
